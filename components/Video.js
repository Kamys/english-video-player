...
export const Video = ({ goToTime }) => {
    ...
    return (React.createElement("video", { onClick: handleTogglePlay, ref: videoRef, className: 'video', controls: false },
        React.createElement("source", { src: videoSrc })));
};
